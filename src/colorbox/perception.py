"""Perception pipelines that move code from the original notebook into modules."""
...
def simple_sam_clip_pipeline(
    ...
    for q in q_checkpoints:
        ...
        for mask in masks:
            ...
            task_id = int(np.argmax(cos_scores))
            if cos_scores[task_id] <= cosine_threshold:
                continue
